...
object housePrices_RandomForest_CV {
...
//    Logger.getLogger("org.apache.eclipse.jetty.server").setLevel(Level.OFF)
    ...
    //创建交叉验证的Pipeline，用 RF作为estimator，用RegressionEvaluator作为evaluator，用rfParamGrid作为hyperparameters
    ...
    // 模型保存
    bestModel.write.overwrite().save("./saveModel/spark-rf-regression-model-housePrices")

    // 模型读取
    val loadModel = PipelineModel.load ("./saveModel/spark-rf-regression-model-housePrices")
