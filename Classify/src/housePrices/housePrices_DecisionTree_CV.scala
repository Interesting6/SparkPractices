...
object housePrices_DecisionTree_CV {
...
//    Logger.getLogger("org.apache.eclipse.jetty.server").setLevel(Level.OFF)
    ...
    //创建交叉验证的Pipeline，用 DT作为estimator，用RegressionEvaluator作为evaluator，用dtParamGrid作为hyperparameters
    ...
    // 模型保存
    bestModel.write.overwrite().save("./saveModel/spark-dt-regression-model-housePrices")

    // 模型读取
    val loadModel = PipelineModel.load ("./saveModel/spark-dt-regression-model-housePrices")
